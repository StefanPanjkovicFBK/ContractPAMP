...
driveleft_running_entry = z3.Bool("BOOL_driveleft_running_entry")
driveright_running_entry = z3.Bool("BOOL_driveright_running_entry")
load_running_entry = z3.Bool("BOOL_load_running_entry")
unload_running_entry = z3.Bool("BOOL_unload_running_entry")
...
driveleft_spec = SmtIoContract.from_z3_terms(
    input_vars = [
        ...
        "t_0",
        "t_1",
        "BOOL_driveleft_running_entry",
        "BOOL_driveright_running_entry",
        "BOOL_load_running_entry",
        "BOOL_unload_running_entry",
    ],
    output_vars = [
        "pos_exit",
    ],
    assumptions = [
        ...
        z3.Not(driveleft_running_entry),
        z3.Not(driveright_running_entry),
        z3.Not(load_running_entry),
        z3.Not(unload_running_entry),
    ],
    guarantees = [
